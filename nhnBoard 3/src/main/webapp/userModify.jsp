...
<fmt:bundle basename="message">
    <form method="post" action="/user/modify.do" enctype="multipart/form-data">
        <div id="border">
            <div class="container">
                <p><fmt:message key="Id"/>:</p><input type="text" name="id" value="${param.userId}" readonly/><br/>
            </div>
            <div class="container">
            ...
            <input style="width:450px; margin-left: 40px;" type="submit" value=<fmt:message key="userModify"/> />
        </div>
    </form>
</fmt:bundle>
</body>
