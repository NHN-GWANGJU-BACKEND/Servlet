...
public class PostTest {
    ...
    HttpSession session;
    User admin = new UserDTO("admin", "12345", "admin", "");
    Post post = new PostDTO("title","content","taewon", LocalDateTime.now());
    Page pagination = new Pagination(1,10,new ArrayList<>(),1);
    ...
    public void postList() {
        ...
        when(mapPostRepository.getPagedPosts(1,10)).thenReturn(pagination);
    ...
    public void postDelete(){
        ...
        String result = command.execute(req, resp);
        Assertions.assertThat(result).isEqualTo("redirect:/postList.do?page=1&size=10");
    }
